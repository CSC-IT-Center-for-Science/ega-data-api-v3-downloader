...
public class FileServiceImpl implements FileService {
    ...
    @Override
    public Iterable<File> getFileByStableId(String fileStableIDs) {
        return fileRepository.findByStableId(fileStableIDs);
    }

    @Override
    public Iterable<File> getDatasetFiles(String datasetStableId) {
        return fileRepository.findByDatasetStableId(datasetStableId);
    }
